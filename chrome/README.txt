...
Drag the ccautologout.crx file onto the page.
Confirm you want to add the extension.
Ensure CCollab Auto-logout extension is installed and enabled.

Note: Because the extension is unsigned, you might get warnings about it not being
from a trusted source, ie: Chrome Web Store.
